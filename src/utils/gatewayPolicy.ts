...
type GatewayPolicyInput = Record<string, any>;

function normalizePolicyInput(payload: GatewayPolicyInput = {}) {
...
function buildEffectivePolicy(rawPolicy: GatewayPolicyInput = {}) {
  return {
    allowedSqlTypes:
...
function getGatewayPayloadOptions(context: { requestEncryptionPassword?: string } | null | undefined) {
  return {
